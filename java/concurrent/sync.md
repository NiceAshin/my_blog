...
![markword](https://cdn.jsdelivr.net/gh/NiceAshin/FileStore/blogImage/markword.png)  
...
4. cas更新成功, 即代表持有了锁, 将锁的标志位设置为00
 ![displaced mark word](https://cdn.jsdelivr.net/gh/NiceAshin/FileStore/blogImage/displacedmarkword.png)
