...
![k8s-veth](https://cdn.jsdelivr.net/gh/NiceAshin/FileStore/blogImage/k8s-veth.png)
...
![k8s-bridge](https://cdn.jsdelivr.net/gh/NiceAshin/FileStore/blogImage/k8s-bridge.png)

单独创建一个Linux bridge是没有任何实际功能的, 因为他只有一个端口连接着协议栈, 只是一个独立的网络设备. 所以网桥一般都是结合veth pair使用. 

![k8s-bridge-veth](https://cdn.jsdelivr.net/gh/NiceAshin/FileStore/blogImage/k8s-bridge-veth.png)
...
![k8s-bridge-veth-ip](https://cdn.jsdelivr.net/gh/NiceAshin/FileStore/blogImage/k8s-bridge-veth-ip.png)
...
![k8s-bridge-eth0](https://cdn.jsdelivr.net/gh/NiceAshin/FileStore/blogImage/k8s-bridge-eth0.png)
...
![k8s-netfilter](https://cdn.jsdelivr.net/gh/NiceAshin/FileStore/blogImage/k8s-netfilter.png)
...
![k8s-iptables55](https://cdn.jsdelivr.net/gh/NiceAshin/FileStore/blogImage/k8s-iptables55.png)
...
![k8s-docker0](https://cdn.jsdelivr.net/gh/NiceAshin/FileStore/blogImage/k8s-docker0.png)

### docker0

bridge模式下的每个容器都会创建一个虚拟的Veth设备对, 一端连接到docker0上, 另一端映射到容器的eth0设备. 然后从docker0的地址段内给eth0接口分配一个IP地址. 

![docker-bridge](https://cdn.jsdelivr.net/gh/NiceAshin/FileStore/blogImage/docker-bridge.png)
